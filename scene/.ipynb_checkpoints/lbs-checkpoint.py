...
def lbs(betas, pose, v_template, expdirs, posedirs, J_regressor, parents,
    ...
    ''' Performs Linear Blend Skinning with the given shape and pose parameters
        ...
        shapedirs : torch.tensor 1xNB  // 这里我改成expdirs
    ...
    v_shaped = v_template + blend_shapes(betas, expdirs)
