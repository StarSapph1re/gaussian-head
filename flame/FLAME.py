...
class FLAME(nn.Module):
    ...
    def __init__(self, flame_model_path, lmk_embedding_path, n_shape, n_exp, shape_params, canonical_expression, canonical_pose):
        ...
        print("v_tem", self.v_template.shape)
        print("shape_p", shape_params.shape)
        ...
        # 传入的pose参数放入canonical_pose的第6个位置
        ...
        print("FLAME Decoder init success")

    # FLAME mesh morphing
    def forward(self, expression_params, full_pose):
        """
            输入expression full_pose，使用lbs对FLAME mesh的形变
            Input:
