...
# d_xyz改成xyz_deformed，并修改mean3D的获取
def render(viewpoint_camera, pc: GaussianModel, triplane: TriPlaneModel, pipe, bg_color: torch.Tensor, xyz_deformed, d_rotation, d_scaling, iteration,
